...
$query = "select izin.*,guru.nama as nama_guru,bk.nama as nama_bk from izin inner join guru on guru.id = izin.guru_id
          inner join bk on bk.id = izin.bk_id where siswa_id = 2";
...
<head>
  ...
  <title>Aplikasi Permudah Tinggalkan Kelaz</title>
                  ...
                  <table class="table text-nowrap mb-0 align-middle">
                    ...
                    <tbody>
                      ...
                      <!-- <tr>
                        ...
                        <td class="border-bottom-0">
                            <h6 class="fw-semibold mb-1">Eka Nur Ahmad </h6>
                        ...
                        <td class="border-bottom-0">
                          <h6 class="fw-semibold mb-0 fs-4">21/1/10SM</h6>
                        </td>
                      </tr>  -->
                    </tbody>
                  </table>
            ...
            <div class="row">
              <div class="col-lg-12">
                ...
                <?php
                 ...
                 $runsql1 = mysqli_query($is_connect,$query1);
                 $runsql2 = mysqli_query($is_connect,$query2);
                 $fetch_data1 = mysqli_fetch_all($runsql1,MYSQLI_ASSOC);               
                 $fetch_data2 = mysqli_fetch_all($runsql2,MYSQLI_ASSOC);
                ?>
